    ...
    <transition name="el-zoom-in-top" @after-leave="handleDropdownLeave">
      <div
        ...
        <cascader-panel
          ...
          @menu-scroll-bottom="(parentNode, resolve) => $emit('menu-scroll-bottom', parentNode, resolve)"></cascader-panel>
        <el-scrollbar
          ref="suggestionPanel"
          v-if="filterable"
          v-show="filtering"
...
import CascaderPanel from '../../cascader-panel/src/cascader-panel.vue';
...
export default {
  ...
  watch: {
    ...
    // 外部传入的，改变时改变checkedValue，并重新computePresentContent
    value(val) {
  ...
  methods: {
    ...
    handleInput(val, event) {
      ...
      /**
       * https://developer.mozilla.org/zh-CN/docs/Web/API/InputEvent/isComposing
       * 例如汉字未组合完成前
       */
    ...
    */
    ...
    bindScrollbarListener() {
      ...
      this.$refs.suggestionPanel.handleScroll = () => {
        ...
        this.$refs.suggestionPanel.moveY = (wrap.scrollTop * 100) / wrap.clientHeight;
        this.$refs.suggestionPanel.moveX = (wrap.scrollLeft * 100) / wrap.clientWidth;
